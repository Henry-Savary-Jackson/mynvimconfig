...
local config = {
  ...
  cmd = {
    ...
    '-jar', vim.fn.glob('~/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository'),

    -- The configuration for jdtls is also placed where jdtls was installed. This will
    -- need to be updated depending on your environment
    '-configuration' , '~/eclipse.jdt.ls/org.eclipse.jdt.ls.product/target/repository/config_linux',
